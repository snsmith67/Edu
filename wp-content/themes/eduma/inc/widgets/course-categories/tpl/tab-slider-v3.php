...
if ( $cat_course ) {
	...
	$html .= '<div class="thim-course-slider" data-visible="' . $item_visible . '" data-tablet="4" data-mobile="1" data-pagination="' . $pagination . '" data-navigation="' . $navigation . '" data-autoplay="' . esc_attr( $autoplay ) . '">';
	$i = 0;
